		...
		<div class="app-dashboard-body off-canvas-wrapper">
			<div id="app-dashboard-sidebar"
				...
				<div>
					<ul id="collapsing-tabs" class="menu vertical tabs">						
						...
						<li class="tab-title is-active"><a href="${path}com/servlet/LogisticFinishing"> <i
								class="large fa fa-industry"></i><span
			...
			<div
				...
				<c:forEach items="${list}" var="oinfo">
						...
						<form action="${path}com/servlet/LogisticUpdateInfo" method="post">					
							<div class="card-info-content">								
							    ...
							    <input name="logisticaddress" placeholder="输入当前物流所在地">
