			...
			<div id="app-dashboard-sidebar"
				...
				<div>
					<ul id="collapsing-tabs" class="menu vertical tabs">
						...
						<li class="tab-title"><a
							href="${path}com/servlet/ShowCustomFinish"> <i
								class="large fa fa-hourglass"></i><span
								class="app-dashboard-sidebar-text">已完成订单</span>
						</a></li>
						<li class="tab-title is-active"><a
							href="${path}com/servlet/ShowCustomUnFinish"> <i
								class="large fa fa-industry"></i><span
								class="app-dashboard-sidebar-text">未完成订单</span>
						</a></li>
						<li class="tab-title"><a
							href="${path}com/servlet/ShowCustomOrder"> <i
								class="large fa fa-hourglass"></i><span
								class="app-dashboard-sidebar-text">待发货</span>
						</a></li>

						<li class="tab-title"><a
							href="${path}com/servlet/ShowCustomUnAccept"> <i
								class="large fa fa-institution"></i><span
					...
					<c:forEach items="${list}" var="oinfo">
						<div class="card-info primary">
								...
								<form action="${path}com/servlet/CancelOrder" method="post">
									<input type="text" name="oid" value="${oinfo.oid}"
										style="display: none">
									...
									<form action="${path}com/servlet/GoodBye" method="post">
										<input type="text" name="oid" value="${oinfo.oid}"
											style="display: none">
										<button type="submit" class="button">完成订单</button>
									</form>								
								</div>
