		...
		<div class="app-dashboard-body off-canvas-wrapper">
			...
			<div
				...
				<div class="tabs-panel content is-active">
					<form action="${path}com/servlet/ZcompSearchOrder" method="post">
						<input name="oid" placeholder="请输入订单号码">
					...
					<div class="card-info primary">
						<div class="card-info-content">
							...
							<p>寄件地址:${saddress}</p>
							<p>总价:${allamount}</p>
							<p>配送信息:${logisticaddress}</p>
							<p>订单状态:${state}</p>
							<h4 style="color: red">*-1-拒收 0-待发货 1-进行中(未完成) 2-已完成</h4>
						</div>
					</div>
