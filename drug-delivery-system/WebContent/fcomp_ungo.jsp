			...
			<div id="app-dashboard-sidebar"
				...
				<div>
					<ul id="collapsing-tabs" class="menu vertical tabs">
						<li class="tab-title"><a href="${path}com/servlet/ShowFAdmin">
						...
						<li class="tab-title"><a
							href="${path}com/servlet/FcompFinish"> <i
								class="large fa fa-hourglass"></i><span
								class="app-dashboard-sidebar-text">已完成订单</span>
						</a></li>
						<li class="tab-title is-active"><a href="${path}com/servlet/FcompUnGo">
								<i class="large fa fa-industry"></i><span
								class="app-dashboard-sidebar-text">未发货订单</span>
						</a></li>
						<li class="tab-title"><a
							href="${path}com/servlet/FcompUnFinish"> <i
								class="large fa fa-industry"></i><span
								class="app-dashboard-sidebar-text">未完成订单</span>
						</a></li>
						<li class="tab-title"><a
							href="${path}com/servlet/FcompUnAccept"> <i
								class="large fa fa-hourglass"></i><span
					...
					<c:forEach items="${list}" var="oinfo">
						<div class="card-info primary">
							<div class="card-info-content">
								<form action="${path}com/servlet/FcompLetGo" method="post">
									...
									<input type="text" id="isrx" value="${oinfo.isrx}" style="display: none">
									<img src="${path}web_pic/${oinfo.webpic}" style="display: none" id="img"></img></br>
									</br>
									<input placeholder="请输入配送负责人id" name="lid">

									<button class="button" type="submit" id="go">发货</button>
								</form>
								<form action="${path}com/servlet/FcompUnLetGo" method="post">
								<input type="text" name="oid" value="${oinfo.oid}" style="display: none">
								<button class="button warning" type="submit">拒绝发货</button>
								</form>
							</div>
						</div>
					</c:forEach>
