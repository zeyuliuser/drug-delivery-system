...
public class FcompUnGo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<OrderInfo> orderInfos = oService.getOrderInfoByDrugStoreIdAndState(drugstoreid,0);
		request.setAttribute("list", orderInfos);
		request.getRequestDispatcher("/fcomp_ungo.jsp").forward(request, response);
	}
